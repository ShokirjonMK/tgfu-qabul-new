...
class CrmPush extends \yii\db\ActiveRecord
{
    ...
    const TEL = 1959579;
    const FILIAL = 1964177;
    const FAMILYA = 1959581;
    const ISM = 1959583;
    const OTASI = 1959585;
    const SERIYA = 1959587;
    const NOMER = 1959589;
    const BIRTHDAY = 1959591;
    const QABUL_TURI = 1959593;
    const TALIM_SHAKLI = 1959597;
    const TALIM_TILI = 1959599;
    const TALIM_KODI = 1964179;
    const TALIM_YONALISH = 1959601;
    const BOSQICH = 1964181;
    const EXAM_TYPE = 1959603;
    const EXAM_DATE = 1964183;
    const EXAM_BALL = 1964185;
    const IMTIXON_XOLATI = 1964187;
    const OFERTA_XOLATI = 1964189;
    const TRANSKRIPT_XOLATI = 1964191;
    const DTM_XOLATI = 1964193;
    const MASTER_XOLATI = 1964195;
    const DOMEN = 1964631;
